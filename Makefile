...
build/test.o: theta_sums/test.cc include/theta_sums.h include/log.h
	g++ -c theta_sums/test.cc $(OPTIONS) $(INCLUDEDIR) -o build/test.o
...
build/theta_sums.o: theta_sums/theta_sums.cc include/theta_sums.h
	g++ -c theta_sums/theta_sums.cc $(OPTIONS) $(INCLUDEDIR) -o build/theta_sums.o

build/direct_evaluation.o: theta_sums/direct_evaluation.cc include/theta_sums.h
	g++ -c theta_sums/direct_evaluation.cc $(OPTIONS) $(INCLUDEDIR) -o build/direct_evaluation.o
...
build/zetacalc.o: include/rs_sum.h zetacalc.cc
	g++ -c zetacalc.cc $(OPTIONS) $(INCLUDEDIR) -o build/zetacalc.o

build/misc.o: theta_sums/misc.cc theta_sums/precomputed_tables.h include/misc.h include/log.h
	g++ -c theta_sums/misc.cc $(OPTIONS) $(INCLUDEDIR) -o build/misc.o
...
build/w_coefficient.o: theta_sums/w_coefficient.cc theta_sums/w_coefficient.h include/misc.h include/theta_sums.h theta_sums/precomputed_tables.h
	g++ -c theta_sums/w_coefficient.cc $(OPTIONS) $(INCLUDEDIR) -o build/w_coefficient.o
